...
import {
  ChangeEventPayload,
  ExpoMeshGradientProps,
} from "./ExpoMeshGradient.types";
...
const emitter = new EventEmitter(
  ExpoMeshGradientModule ?? NativeModulesProxy.ExpoMeshGradient
);
...
export { ExpoMeshGradientView, ExpoMeshGradientProps, ChangeEventPayload };
